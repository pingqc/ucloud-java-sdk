 ...
 * @author pingqc
 */
public class TerminateUHostInstanceRequest implements
		UCloudRequest<TerminateUHostInstanceResponse> {

	private static final String ACTION = "TerminateUHostInstance";
	...
	@Override
	public Class<TerminateUHostInstanceResponse> getResponseClass() {
		return TerminateUHostInstanceResponse.class;
	}
